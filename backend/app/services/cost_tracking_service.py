...
from app.services.agent_registry import AgentType, AGENT_REGISTRY
...
class CostTrackingService:
    ...
    async def get_weekly_cost(self, date: Optional[datetime] = None) -> float:
    ...
    async def estimate_remaining_cost(
        self,
        goal_id: str,
        avg_cost_per_ticket: Optional[float] = None
    ) -> Dict[str, float]:
