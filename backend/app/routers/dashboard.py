...
async def get_sprint_metrics(db: AsyncSession, goal_id: str | None = None) -> SprintMetrics:
...
async def get_agent_metrics(db: AsyncSession, goal_id: str | None = None) -> AgentMetrics:
