...
down_revision: Union[str, None] = 'b10fb0b62240'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('messages_json', sa.Text(), nullable=True),  # Empty by default (lean storage)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_agent_conversation_history_created_at', table_name='agent_conversation_history')
    op.drop_index('ix_agent_conversation_history_goal_id', table_name='agent_conversation_history')
