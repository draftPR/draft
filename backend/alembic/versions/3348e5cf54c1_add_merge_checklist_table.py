...
down_revision: Union[str, None] = '8f3e2bd8ea3b'
...
def upgrade() -> None:
    ...
    op.create_table('merge_checklists',
    ...
    op.create_index(op.f('ix_merge_checklists_goal_id'), 'merge_checklists', ['goal_id'], unique=False)
