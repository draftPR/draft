...
A simple calculator application with some bugs and missing features - perfect for demonstrating Draft's autonomous code delivery.

## What's Wrong?

This codebase has several issues that Draft will help fix:
...
1. Start Draft (it's already running if you see this!)
...
5. Watch as Draft autonomously implements the fixes
